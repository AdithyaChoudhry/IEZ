  ...
  theme: {
    extend: {
      ...
      keyframes: {
        ...
        'glow-em':     { '0%,100%':{boxShadow:'0 0 8px rgba(59,130,246,0.2)'}, '50%':{boxShadow:'0 0 28px rgba(59,130,246,0.45)'} },
        'pulse-ring':  { '0%':{transform:'scale(0.95)',boxShadow:'0 0 0 0 rgba(59,130,246,0.35)'}, '70%':{transform:'scale(1)',boxShadow:'0 0 0 10px rgba(59,130,246,0)'}, '100%':{transform:'scale(0.95)',boxShadow:'0 0 0 0 rgba(59,130,246,0)'} },
